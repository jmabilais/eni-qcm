 ...
 * @ORM\Entity(repositoryClass="Eni\FrontendBundle\QuestionTirageRepository")
 */
class QuestionTirage {
	...
	/**
	 * @ORM\ManyToOne(targetEntity="Eni\BackendBundle\Entity\Question", cascade={"all"}, inversedBy="questionTirages")
